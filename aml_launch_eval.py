...
def submit_to_aml(args: argparse.Namespace) -> None:
    ...
    job = command(
        ...
        display_name=args.display_name + '-eval',
        instance_count=args.instance_count,
        resources=vc_config,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--tokenized-data-uri",
        default="azureml://subscriptions/5c9e4789-4852-4ffe-8551-d682affcbd74/resourcegroups/manifold2-rg/workspaces/as-manifold2-sa-ws/datastores/sa_qat/paths/llama_tokenized_data_slimpajama_10b_v1/",
        required=False,
        help="Azure ML data asset or cloud URI providing training data (mapped to train_data_local_path).",
    )
    parser.add_argument(
